...
package carl.urc.common.client;

public class ClientPreferences {
	// DV-LP-CARL-L
	//public static final String preferenceDefaultDevice = "00242CBDC854";

	// Entertain
	public static final String preferenceDefaultDevice = "94A900280007";
	
	public static final int preferenceAlertTimeout = 3000;

	public static final String preferenceDefaultIp = "192.168.0.103";
}
