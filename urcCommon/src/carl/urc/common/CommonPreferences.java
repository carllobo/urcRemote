...
package carl.urc.common;

public class CommonPreferences {

	public static boolean preferenceAuthenticate = false;
	
	public static String preferencePassword = "foo";

	public static int preferenceBufferStart = 3;

	public static String preferenceDefaultPort = "1030";
}
