...
public class ProtocolException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4800459417015647259L;

	public ProtocolException(byte arg0) {
		super("Unable to resolve: " + arg0);
	}
	...
	public ProtocolException(UrcNetworkMethod method) {
		super("Unable to dispatch: " + method.getClass().getName());
	}
}
