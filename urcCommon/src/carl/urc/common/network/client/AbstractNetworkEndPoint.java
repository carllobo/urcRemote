...
public abstract class AbstractNetworkEndPoint implements NetworkEndPoint {

	private String remoteConnectionInfo;

	protected AbstractNetworkEndPoint(String remoteConnectionInfo) {
		this.remoteConnectionInfo = remoteConnectionInfo;
	}

	public final String getRemoteConnectionInfo() {
