...
public class BluetoothCommonPreferences {
	public static boolean preferenceEncrypt = true;
	
	public static boolean preferenceAuthenticate = true;
	
	public static String preferenceDefaultChannel = "15";
	
	public static String preferenceDefaultPSM = "1001";
}
