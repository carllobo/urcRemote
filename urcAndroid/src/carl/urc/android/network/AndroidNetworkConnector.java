...
package carl.urc.android.network;

import carl.urc.android.UrcAndroidApp;
import carl.urc.common.network.client.NetworkConnector;

public abstract class AndroidNetworkConnector extends NetworkConnector {
	
	protected UrcAndroidApp application;
	
	public AndroidNetworkConnector(UrcAndroidApp application) {
		super(application);
