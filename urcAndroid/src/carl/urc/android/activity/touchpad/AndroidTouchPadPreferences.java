...
public class AndroidTouchPadPreferences extends TouchPadPreferences {
	...
	public static final float preferenceMoveAcceleration = 1.3f;
	...
	public static final int preferenceVibrationTime = 50;

	public AndroidTouchPadPreferences() {
